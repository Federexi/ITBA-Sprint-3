        ...
        for(i = 0; i < data.length; i++){
            ...
            if(data[i].casa.nombre == "Dolar Oficial"){
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    oficialVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    oficialVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    blueVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    blueVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    liquiVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    liquiVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    promVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    promVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    bolsaVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    bolsaVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
                ...
                if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) > 0){
                    turistaVar.innerHTML = `<img src="../archivos/up.svg" class="up"></img> VARIACION +${data[i].casa.variacion}%`
                }
                else if(parseFloat(data[i].casa.variacion.replace(/,/g, '.')) < 0){
                    turistaVar.innerHTML = `<img src="../archivos/down.svg" class="down"></img> VARIACION ${data[i].casa.variacion}%`
                }
                else{
